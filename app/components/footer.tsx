...
export default function Footer() {
  return (
    <footer className="flex grow flex-col justify-end mb-4">
      <ul className="font-sm mt-4 flex flex-col space-x-0 space-y-2 text-neutral-600 md:flex-row md:space-x-4 md:space-y-0 dark:text-neutral-300">
        ...
        <li>
          <a
            ...
            rel="noopener noreferrer"
            target="_blank"
            href="https://github.com/jefishub/"
          >
            <ArrowIcon />
        ...
        <li>
          <a
            ...
            rel="noopener noreferrer"
            target="_blank"
            href="https://github.com/jefishub/portfolio-nextjs"
          >
            <ArrowIcon />
      ...
      <p className="mt-4 text-neutral-600 dark:text-neutral-300">
        © {new Date().getFullYear()} Jere Manni
      </p>
    </footer>
  )
}
